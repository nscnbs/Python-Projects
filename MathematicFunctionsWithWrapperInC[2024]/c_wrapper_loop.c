// gcc -I/usr/include/python3.10 c_wrapper_loop.c -o c_wrapper_loop -lpython3.10
...
int factorial_wrapper(int n)
{
    ...
    pName = PyUnicode_DecodeFSDefault("library_loop");
    ...
    {
        PyErr_Print();
        fprintf(stderr, "Failed to load \"library_loop\" module\n");
    }
